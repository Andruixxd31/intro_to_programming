...
AHORCADO = ['''
    ...
    =========''', '''
     ...
     / \  |
          |
    =========''']
palabras = """supercalifragilistico asombroso python java electricidad truing perceptron 
tesla macintosh oracle neurona sigmoid teclado weka anaconda jupiter macpro mohave javascript ruby alphago 
redes pascal basic lisp perl typescript swift objective-c powershell matlab eniac fortran cobol mathematica 
groovy """.split()
